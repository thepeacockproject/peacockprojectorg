...
Peacockissa voit pelata Elusive Targetteja ilman aikarajoituksia uudelleen yrittämisen yhteydessä (toisin kuin Elusive Target Arcade pelitilassa), ja ilman aikarajaa.
* **How to Play**:
...
* **Custom Peacock Escalations**
  * Peacock supports custom (Peacock original) escalations. These escalations are available in-game by default. You can see some custom escalations listed in the [Roadmaps](https://thepeacockproject.org/wiki/roadmaps) as well.
