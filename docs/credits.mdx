...
<div className="card">
    ...
    <div className="card__body">
        <small>
        Tinosaurus, the Finnish <del>Adeze Oijofor´s worst nightmare</del> helper guy. Been around for a long time. Writes Bug Reports, Helps with smaller things related to development,
            a moderator of the HITMAN&trade; games on speedrun.com. Studying computer science in university, also doing things with the website.
        </small>
    </div>
</div>
