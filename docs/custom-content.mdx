...
* **User Created, Official Server Contracts**
  * How to Install: 
	  ...
	  * The contract will now be downloaded in `...Peacock-vx.x.x/Peacock-vx.x.x/Contracts/`.
  * How to Play: Go to `Game Modes` -> `Contracts` -> `My Contracts` in-game to play.
* **User Created, Peacock Contracts**
  * How to Install: 
    * Download the contracts `.ocre` file from the `share-contracts` channel in Peacock Discord. Install this `.ocre` file to your `...Peacock-vx.x.x/Peacock-vx.x.x/Contracts` folder.
    * How to Create Your Own: 
    * If you create a contract in-game while in Peacock server, your contract will be saved as an `.ocre` file in `...Peacock-vx.x.x/Peacock-vx.x.x/Contracts` folder. 
...
* **How to Install Plugins**: 
	...
	* Then, install it to your main Peacock install folder (`...Peacock-vx.x.x/Peacock-vx.x.x`). 
